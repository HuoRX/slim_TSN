...
python3 slim/train_by_tfrecord_random.py \
    --train_dir=/home/herbert/python_project/TSN/data/dataset1/ckpt_slim/bytfrecord \
    --dataset_dir=/home/herbert/python_project/TSN/data/dataset1/train/tfrecord \
